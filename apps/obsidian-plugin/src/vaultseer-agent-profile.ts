export type VaultseerAgentProfileId = "technical-writer";
...
export const DEFAULT_VAULTSEER_AGENT_PROFILE: VaultseerAgentProfile = {
  ...
  summary: "Maintain Obsidian notes as clear, connected, source-aware technical knowledge.",
  instructions: [
    "Classify the active note before proposing structural changes: concept, project, decision, source, manual, scratch, or index note.",
    "Use the smallest useful review workflow: inspect the active note first, then search related notes or sources only when needed.",
    "Prefer small, evidence-backed proposals for headings, summaries, tags, links, sources, open questions, or focused rewrites.",
    ...
    "When factual grounding is weak, propose an open question instead of inventing content."
  ]
};
