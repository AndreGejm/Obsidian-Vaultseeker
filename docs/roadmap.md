...
Status: in progress. The core model namespace, deterministic queue planner, and persisted semantic records are implemented; provider calls, cancellation UI, and semantic search UI are not implemented yet.
